...
namespace vflib
{
  ...
  CloneableVF3ParallelSubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::CloneableVF3ParallelSubState(ARGraph<Node1, Edge1> *ag1, ARGraph<Node2, Edge2> *ag2,
                                                                                                                                       uint32_t *class_1, uint32_t *class_2, uint32_t nclass, nodeID_t *order, bool induced) : predecessors(ag1->NodeCount()),
                                                                                                                                                                                                                                      dir(ag1->NodeCount())
  {
  ...
  CloneableVF3ParallelSubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::
      CloneableVF3ParallelSubState(const CloneableVF3ParallelSubState &state, bool hard_copy) : predecessors(state.predecessors), dir(state.dir)
  {
    if (hard_copy)
    {
  ...
  template <typename Node1, typename Node2,
            typename Edge1, typename Edge2,
            typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
  bool CloneableVF3ParallelSubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::NextPair(nodeID_t *pn1, nodeID_t *pn2, nodeID_t prev_n1, nodeID_t prev_n2)
  {
                                    ...
                                    EdgeComparisonFunctor>::IsFeasiblePair(nodeID_t node1, nodeID_t node2)
  {
    ...
    if (g1->InEdgeCount(node1) > g2->InEdgeCount(node2) || g1->OutEdgeCount(node1) > g2->OutEdgeCount(node2))
      return false;
